...
v1   <- 0.013    #biomass-specific decay multiplier       (mgC mgB-1 time-1) 
...
h1   <- 0.001    #biomass turnover rate multiplier        (1/time)
...
#These have been changed for revised pH model.
