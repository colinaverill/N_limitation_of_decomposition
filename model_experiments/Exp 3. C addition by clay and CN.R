#fertilize with a 1 mg C dose, equivalent to 1000 kg C / ha / yr
...
#addition rate of 1 mg / g soil / yr in our model, ~1000 kg C / ha / yr.
...
for(k in 1:length(v2.range)){
  ...
  out.list <- list()
    ...
    for(i in 1:t){
      ...
      #Drop in C fertilization at t=80000 (index 4000 w/ thinning at 20)
      if(day > fert.day){
        dCdt = dCdt + fert.level
      }
