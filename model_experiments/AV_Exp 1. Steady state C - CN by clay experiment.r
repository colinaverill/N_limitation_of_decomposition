...
model.path      <- 'av_model.r'
parameters.path <- 'av_parameters.r'
no.clay.path    <- 'experiment_output/AV_no_clay.CN_NUE_model.rds'
lo.clay.path    <- 'experiment_output/AV_lo_clay.CN_NUE_model.rds'
hi.clay.path    <- 'experiment_output/AV_hi_clay.CN_NUE_model.rds'
